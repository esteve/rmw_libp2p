...
#[no_mangle]
pub extern "C" fn rmw_fini_publisher_allocation(allocation: *mut rmw_publisher_allocation_t) -> rmw_ret_t {
...
pub extern "C" fn rmw_create_publisher(
    ...
    unsafe { libp2p_c__rmw_create_publisher(node, type_support, topic_name, qos_profile, publisher_options) }
    }
...
pub extern "C" fn rmw_create_subscription(
    ...
    unsafe { libp2p_c__rmw_create_subscription(node, type_support, topic_name, qos_policies, subscription_options) } 
...
pub extern "C" fn rmw_take_with_info(
    ...
    unsafe { libp2p_c__rmw_take_with_info(subscription, ros_message, taken, message_info, allocation) }
...
pub extern "C" fn rmw_take_sequence(
    ...
    unsafe { libp2p_c__rmw_take_sequence(subscription, count, message_sequence, message_info_sequence, taken, allocation) }
...
pub extern "C" fn rmw_take_serialized_message(
    ...
    unsafe { libp2p_c__rmw_take_serialized_message(subscription, serialized_message, taken, allocation) }
...
pub extern "C" fn rmw_take_serialized_message_with_info(
    ...
    unsafe { libp2p_c__rmw_take_serialized_message_with_info(subscription, serialized_message, taken, message_info, allocation) }
...
pub extern "C" fn rmw_take_loaned_message_with_info(
    ...
    unsafe { libp2p_c__rmw_take_loaned_message_with_info(subscription, loaned_message, taken, message_info, allocation) }
...
#[no_mangle]
pub extern "C" fn rmw_destroy_client(node: *mut rmw_node_t, client: *mut rmw_client_t) -> rmw_ret_t {
...
#[no_mangle]
pub extern "C" fn rmw_destroy_service(node: *mut rmw_node_t, service: *mut rmw_service_t) -> rmw_ret_t {
...
pub extern "C" fn rmw_wait(
    ...
    unsafe { libp2p_c__rmw_wait(subscriptions, guard_conditions, services, clients, events, wait_set, wait_timeout) }
...
pub extern "C" fn rmw_get_node_names_with_enclaves(
    ...
    unsafe { libp2p_c__rmw_get_node_names_with_enclaves(node, node_names, node_namespaces, enclaves)  }
...
pub extern "C" fn rmw_subscription_set_on_new_message_callback(
    ...
    unsafe { libp2p_c__rmw_subscription_set_on_new_message_callback(subscription, callback, user_data) }
    }
